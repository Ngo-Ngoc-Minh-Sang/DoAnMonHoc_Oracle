...
namespace DoAnMonHoc.GUI
{
    public partial class menu : Form
    {
        ...
        bool KIEMTRATONTAIFROM(string tenfrom)
        {
            foreach (Form f in MdiChildren)
            {
                if (f.Name.Equals(tenfrom))
                    return true;
            }
            return false;
        }
        ...
        {
            if (!KIEMTRATONTAIFROM("frmKhachHang"))
            {
        ...
        private void toolStripDichVu_Click(object sender, EventArgs e)
        {
            if (!KIEMTRATONTAIFROM("DichVu"))
            {
